...
- [June Light Detection Workplan](development/june-light-detection-workplan.md): plan histórico de junio; conserva el contexto con el que se cerró `LightDetection`, no el siguiente bloque activo.
