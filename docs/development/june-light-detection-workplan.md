...
- Leer la sección de `LightDetection` en `architecture.md`.
...
- Revisar cómo el prototipo actual construye ROIs desde la UI.
- Mapear esos valores a `LightDetectionConfig`.
- No cambiar todavía el comportamiento visual.
...
- Lista de límites conocidos y recomendaciones para elegir umbrales.
